...
#define MAX_DIRTY_GV_SIZE 32 //temp
...
#define SELF_CHAN_POINTER_INIT           0x0000U
...
#define SELF_FIELD_TYPE(type) FIELD_TYPE(type)
...
#define SELF_FIELD_META_INITIALIZER { (SELF_CHAN_POINTER_INIT) }
